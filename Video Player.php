...
<?php
	...
	$_SESSION['movie'] = "your name";//play buttons on home page need to link to this and change this SESSION variable
	
	if($_SESSION['movie'] === "your name"){
	...
	<iframe src="https://cdn.jwplayer.com/players/kGD375IS-wMbjKtxS.html" width="100%" height="100%" frameborder="0" 
											scrolling="auto" allowfullscreen controlbar = "none" style="position:absolute;"></iframe></div>';
	}
	else if($_SESSION['movie'] === "generic"){
		echo '<div style="position:relative; padding-bottom:56.25%; overflow:hidden;">
	<iframe src="https://cdn.jwplayer.com/players/aK2iBmpV-wMbjKtxS.html" width="100%" height="100%" frameborder="0" 
									scrolling="auto" allowfullscreen style="position:absolute;"></iframe></div>';
	}
	else if($_SESSION['movie'] === "patrick"){
		echo '<div style="position:relative; padding-bottom:56.25%; overflow:hidden;">
	<iframe src="https://cdn.jwplayer.com/players/NllofW4e-wMbjKtxS.html" width="100%" height="100%" frameborder="0" 
									scrolling="auto" allowfullscreen style="position:absolute;"></iframe></div>';
	}
?>
