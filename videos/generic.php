...
<?php
	...
	echo '<div style="position:relative; padding-bottom:56.25%; overflow:hidden;"><iframe src="https://cdn.jwplayer.com/players/aK2iBmpV-wMbjKtxS.html" width="100%" height="100%" frameborder="0" scrolling="auto" allowfullscreen style="position:absolute;"></iframe></div>';
...
<form action = "submit.php" method = "post">
	...
	<input type="hidden" name="return" value="http://danc.ddns.net/videos/generic.php">
</form>
</html>
